    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'access-control/clear-events' => 'access-control/clear-events',
                'history' => 'history/index',
                'payment' => 'payment/index',
                'payment/search-clients' => 'payment/search-clients',
                'payment/check-active-membership' => 'payment/check-active-membership',
                'payment/client-receipts' => 'payment/client-receipts',
                'payment/export-receipt-pdf' => 'payment/export-receipt-pdf',
                'payment/process-qr' => 'payment/process-qr',
                'payment/process-cash' => 'payment/process-cash',
                'payment/validate-student' => 'payment/validate-student',
                'payment/client-self-renew' => 'payment/client-self-renew',
                'payment/get-receipt' => 'payment/get-receipt',
                'membership' => 'membership/index',
                'user-management/check-ci' => 'user-management/check-ci',
                'user-management/api-create' => 'user-management/api-create',
            ],
        ],
    ],
    'params' => $params,
